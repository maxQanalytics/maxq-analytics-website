...
| Quality Guardian | `/add-ons/quality-guardian-2026-09-14-amber-badger-fjord` | 2026-09-14 | same folder and flow SVG | preview (edition 4 + 'In production: Freeday' section) |
| Quality Guardian | `/add-ons/quality-guardian-2026-09-14-quartz-badger-cove` | 2026-09-14 | same folder and flow SVG | preview (edition 5 + screenshot lightbox: hover lift, click to open full width, Escape/click/× to close) |
